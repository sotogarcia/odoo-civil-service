...
class AcademyPublicTenderingRssBopacItem(models.Model):
    ...
    _name = 'academy.public.tendering.rss.bopac.item'
    _description = u'Academy public tendering rss item Bopac'
